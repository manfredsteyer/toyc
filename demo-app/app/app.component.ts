...
@Component({
  ...
  template: `
    ...
    <div class="fluent-container" style="padding:20px">
      <div class="row">
        <div class="col-md-6">
          <textarea (keydown)="keydown($event)" spellcheck="false" id="pascal" [(ngModel)]="pascal" style="width:100%;height:500px"></textarea>
        </div>
        <div class="col-md-4">
